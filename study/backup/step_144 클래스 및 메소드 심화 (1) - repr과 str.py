...
class Car():
    ...
    def __repr__(self):  # __str__ 차이점 : 프린트문을 출력할 때는 str, 자료형의 타입때로 그대로 표현해줄 때는 repr
...
print(car1)  # <__main__.Car object at 0x0000019C40FE12C8> _> __str__ --> __repr__

car2 = Car('Bmw', {'color': 'Black', 'horsepower': 270, 'price': 5000})
car3 = Car('Audi', {'color': 'Silver', 'horsepower': 300, 'price': 6000})

print(car1.__dict__)    # 객체의 속성정보를 딕셔너리로 확인할 수 있다.
print(car2.__dict__)
print(car3.__dict__)
...
# 반복(__str__)
for x in car_list:
    print(repr(x))  # repr 명시적 호출 위해 repr 함수 이용한 경우이다.
    print(x)

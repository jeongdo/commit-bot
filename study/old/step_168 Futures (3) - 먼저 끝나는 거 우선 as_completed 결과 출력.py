...
def main():
    ...
    # 결과 건수
    with ProcessPoolExecutor() as excutor:      # ProcessPoolExecutor : 프로세스 풀을 사용하여 호출을 비동기적으로 실행
    # with ThreadPoolExecutor() as excutor:     # ThreadPoolExecutor : 스레드 풀을 사용하여 호출을 비동기적으로 실행
        ...
        # wait 결과 출력
        # result = wait(futures_list, timeout=7)  # 7초안에 해당 작업을 지정해서, 지정시간이 오버하면 작업 중단한다.
        # # 성공
        ...
        for future in as_completed(futures_list):
            ...
            cancelled = future.cancelled    # 취소가 되었는지 확인
            # future 결과 확인
